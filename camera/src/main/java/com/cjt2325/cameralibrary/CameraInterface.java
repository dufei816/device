        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size previewSize = CameraParamUtil.getInstance().getPreviewSize(mParams
                        .getSupportedPreviewSizes(), 1280, screenProp);
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), 1280, screenProp);
...
//        }
    ...
    private void findAvailableCameras() {
        ...
        for (int i = 0; i < cameraNum; i++) {
            ...
            switch (info.facing) {
                case Camera.CameraInfo.CAMERA_FACING_FRONT://camera_front_position
    ...
    void setErrorListener(ErrorListener errorLisenter) {
